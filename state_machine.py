...
class PressMachine(StateMachine):
    ...
    def __init__(self, conn_handler, *args, **kwargs):
    ...
    def on_process_data(self):
        ...
        for measurement in data:
            force_vals.append(measurement[force_index]), height_vals.append(-1 * (measurement[height_index] - first_height_value))

        self.current_data = list()

        self.conn_handler.post_values({"force": force_vals, "height": height_vals})
